...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1.375; // output (wheel) speed / input (motor) speed
     ...
     * Resulting in 106.48035600260904 in/s.
     * This is only 85% of the theoretical maximum velocity of the bot, following the recommendation above.
     * This is capped at 85% because there are a number of variables that will prevent your bot from actually
     * reaching this maximum velocity: voltage dropping over the game, bot weight, general mechanical inefficiencies, etc.
     * However, you can push this higher yourself if you'd like. Perhaps raise it to 90-95% of the theoretically 
     * max velocity. The theoretically maximum velocity is 125.271007061893 in/s.
     * Just make sure that your bot can actually reach this maximum velocity. Path following will be detrimentally
     * affected if it is aiming for a velocity not actually possible.
     * 
     * The maximum acceleration is somewhat arbitrary and it is recommended that you tweak this yourself based on
     * actual testing. Just set it at a reasonable value and keep increasing until your path following starts
     * to degrade. As of now, it simply mirrors the velocity, resulting in 106.48035600260904 in/s/s
     *
     ...
     * (Your recommended velocity was 106.48035600260904in/s)
    ...
    public static double MAX_ANG_VEL = Math.toRadians(349.60136652050227);
    public static double MAX_ANG_ACCEL = Math.toRadians(349.60136652050227);
